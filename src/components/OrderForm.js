						...
						<div class="showcase">
							{this.state.mode === 'Pickup' || this.state.mode === '' ? 
								<div id="pickupForm" class="slideRight">
									...
									<button class="datePickerButton"><DatePicker selected={this.state.pDate} onChange={date => this.setState({ pDate: date })} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} format='MM-dd-yyyy' placeholderText="Date of Pickup" id="pickupPicker" /></button>
							...
							{this.state.mode === 'Delivery' ?
								<div id="deliveryForm" class="slideRight">
									...
									{this.state.route !== '' && this.state.route === 'Route1' ?
										<button class="datePickerButton"><DatePicker selected={this.state.dDate} onChange={date => this.setDate(date)} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} filterDate={this.dateFilterRoute1} format='MM-dd-yyyy' placeholderText="Date of Delivery" id="deliveryPicker" /></button>
									: null}

									{this.state.route !== '' && this.state.route === 'Route2' ?
										<button class="datePickerButton"><DatePicker selected={this.state.dDate} onChange={date => this.setDate(date)} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} filterDate={this.dateFilterRoute2} format='MM-dd-yyyy' placeholderText="Date of Delivery" id="deliveryPicker" /></button>
									: null}

									{this.state.route !== '' && this.state.route === 'Route3' ?
										<button class="datePickerButton"><DatePicker selected={this.state.dDate} onChange={date => this.setDate(date)} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} filterDate={this.dateFilterRoute3} format='MM-dd-yyyy' placeholderText="Date of Delivery" id="deliveryPicker" /></button>
									: null}
