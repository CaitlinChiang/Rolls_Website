							...
							{this.state.mode === 'Delivery' ?
								<div id="deliveryForm" class="slideRight">
									...
									{this.state.route !== '' && this.state.route === 'Route1' ?
										<DatePicker withPortal onChange={date => this.setDate(date)} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} filterDate={this.dateFilterRoute1} format='MM-dd-yyyy' placeholderText="Date of Delivery" id="deliveryPicker" />
									: null}

									{this.state.route !== '' && this.state.route === 'Route2' ?
										<DatePicker withPortal selected={this.state.dDate} onChange={date => this.setDate(date)} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} filterDate={this.dateFilterRoute2} format='MM-dd-yyyy' placeholderText="Date of Delivery" id="deliveryPicker" />
									: null}

									{this.state.route !== '' && this.state.route === 'Route3' ?
										<DatePicker withPortal selected={this.state.dDate} onChange={date => this.setDate(date)} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} filterDate={this.dateFilterRoute3} format='MM-dd-yyyy' placeholderText="Date of Delivery" id="deliveryPicker" />
									: null}
