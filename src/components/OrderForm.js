						...
						<div class="showcase">
							{this.state.mode === 'Pickup' || this.state.mode === '' ? 
								<div id="pickupForm" class="slideRight">
									...
									<DatePicker onFocus={(e) => e.target.readOnly = true} selected={this.state.pDate} onChange={date => this.setState({ pDate: date })} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} format='MM-dd-yyyy' placeholderText="Date of Pickup" id="pickupPicker" />
							...
							{this.state.mode === 'Delivery' ?
								<div id="deliveryForm" class="slideRight">
									...
									{this.state.route !== '' && this.state.route === 'Route1' ?
										<DatePicker onFocus={(e) => e.target.readOnly = true} selected={this.state.dDate} onChange={date => this.setDate(date)} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} filterDate={this.dateFilterRoute1} format='MM-dd-yyyy' placeholderText="Date of Delivery" id="deliveryPicker" />
									: null}

									{this.state.route !== '' && this.state.route === 'Route2' ?
										<DatePicker onFocus={(e) => e.target.readOnly = true} selected={this.state.dDate} onChange={date => this.setDate(date)} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} filterDate={this.dateFilterRoute2} format='MM-dd-yyyy' placeholderText="Date of Delivery" id="deliveryPicker" />
									: null}

									{this.state.route !== '' && this.state.route === 'Route3' ?
										<DatePicker onFocus={(e) => e.target.readOnly = true} selected={this.state.dDate} onChange={date => this.setDate(date)} minDate={addDays(new Date(), 1)} maxDate={addMonths(new Date(), 2)} filterDate={this.dateFilterRoute3} format='MM-dd-yyyy' placeholderText="Date of Delivery" id="deliveryPicker" />
									: null}
