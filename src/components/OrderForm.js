		...
		if (this.state.pendingOrders && this.state.pendingOrders.length > 0) {
			if (this.state.mode === 'Pickup') {
				if (this.state.name.trim() !== "" && this.state.number.trim() !== "" && this.state.mode.trim() !== "" && this.state.pDate !== "" && this.state.pPayment.trim() !== "" && this.state.pInstructions.length > 0) {
					if (this.state.pInstructions.includes('Personalized') || this.state.pInstructions.includes('Candle') || this.state.pInstructions.includes('extraFrosting') || this.state.pInstructions.includes('None')) {
						if (this.state.pNote.trim() !== '' || this.state.pNote.trim() === '') {
				...
				if (this.state.pendingOrders.length < 2 && this.state.pendingOrders.includes('P1')) {
					...
					if (this.state.name.trim() !== "" && this.state.number.trim() !== "" && this.state.mode.trim() !== "" && this.state.dPayment.trim() !== "" && this.state.address.trim() !== "" && this.state.city.trim() !== "" && this.state.dDate !== "" && this.state.dInstructions.length > 0) {
						if (this.state.dInstructions.includes('Personalized') || this.state.dInstructions.includes('Candle') || this.state.dInstructions.includes('extraFrosting') || this.state.dInstructions.includes('None')) {
							if (this.state.dNote.trim() !== '' || this.state.dNote.trim() === '') {
