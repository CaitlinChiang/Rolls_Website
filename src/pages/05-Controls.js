				...
				<section id="viewing">
					<div class="container slideDown">
						...
						<div class="filter">
							...
							<DatePicker selected={this.state.dateFilter} onChange={date => this.setState({ dateFilter: date })} minDate={new Date()} maxDate={addMonths(new Date(), 2)} format='MM-dd-yyyy' placeholderText="Date" id="filterPicker" />
						</div>
